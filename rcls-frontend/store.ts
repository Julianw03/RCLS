...
const ACTION_SET_BACKEND_CONNECTION_STATE = createAction<BackendConnectionState>("backendConnectionState/set");
const ACTION_RESET_BACKEND_CONNECTION_STATE = createAction("backendConnectionState/reset");
