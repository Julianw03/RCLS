...
public class ProcessTakeoverConnectionStrategy implements RiotClientConnectionStrategy {
    ...
    public RiotClientConnectionParameters connect() throws Exception {
        ...
        log.debug("Generated parameters: {}", parameters);
                    ...
                    .exceptionally(ex -> {
                        if (ex instanceof CompletionException) {
                            if (ex.getCause() instanceof UnsupportedOperationException) {
                                log.info("Game {} is not supported on this OS", game);
                            }
                            return null;
                        }
        ...
        try {
            ...
            throw new ExecutionException("Failed to kill all running games", e);
        }
        ...
        try {
            ...
            throw new ExecutionException("Failed to kill previous Riot Client Instance", e);
        }
        ...
        try {
            ...
            throw new ExecutionException("Failed to kill previous RiotClientServices Instance", e);
        }
        ...
        try {
            ...
            throw new ExecutionException("Failed to start Riot Client Services with own parameters", e);
        }
